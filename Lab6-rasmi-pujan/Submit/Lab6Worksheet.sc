...
("hello")
//var x=( /^.*H$/ , RConcat(RStar(RAnyChar),RSingle(H)) )
...
val str = "af".toCharArray
val a = str(0)
val f=str(1)
val str1="b".toCharArray
val b=str1(0)
...
retest(RStar(RSingle(a)), "af")
retest(RStar(RSingle(b)),"bb")
val x="a*(ab)|a+b*"
RegExprParser.parse(x)